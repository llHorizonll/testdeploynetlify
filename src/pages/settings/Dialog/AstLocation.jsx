...
import { getAstLocationSearchList } from "services/asset";
import MUIDataTable from "mui-datatables";
import ActionMenu from "components/ActionMenu";
import DialogItem from "./AstLocationItem";
...
const DialogAstLocation = (props) => {
  ...
  const fetchSearchList = async (uriQueryString) => {
    uriQueryString.WhereLikeFields = ["AstLocCode", "AstLocDesc"];
    const { Data, Paging } = await getAstLocationSearchList(uriQueryString);
    if (Data) {
      setData(Data);
      setPaging(Paging);
...
export default DialogAstLocation;
