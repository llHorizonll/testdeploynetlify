...
import { getAstCategorySearchList } from "services/asset";
import MUIDataTable from "mui-datatables";
import ActionMenu from "components/ActionMenu";
import DialogItem from "./AstCategoryItem";
...
const DialogAstCategory = (props) => {
  ...
  const fetchSearchList = async (uriQueryString) => {
    uriQueryString.WhereLikeFields = ["AstCateCode", "AstCateDesc"];
    const { Data, Paging } = await getAstCategorySearchList(uriQueryString);
    if (Data) {
      setData(Data);
      setPaging(Paging);
  ...
  React.useEffect(() => {
    if (open) {
      console.log(uriQueryString, "first");
      fetchSearchList(uriQueryString);
    }
  }, [open]);
...
export default DialogAstCategory;
