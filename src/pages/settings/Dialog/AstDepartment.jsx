...
import { getAstDepartmentSearchList } from "services/asset";
import MUIDataTable from "mui-datatables";
import ActionMenu from "components/ActionMenu";
import DialogItem from "./AstDepartmentItem";
...
const DialogAstDepartment = (props) => {
  ...
  const fetchSearchList = async (uriQueryString) => {
    uriQueryString.WhereLikeFields = ["AstDeptCode", "AstDeptDesc"];
    const { Data, Paging } = await getAstDepartmentSearchList(uriQueryString);
    if (Data) {
      setData(Data);
      setPaging(Paging);
...
export default DialogAstDepartment;
